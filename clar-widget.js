...
(function () {
  ...
  var css = [
    ...
    ".clar-searchbox input{width:100%;border:none;border-radius:11px;padding:13px 38px 13px 14px;font:15px system-ui;outline:3px solid transparent;box-sizing:border-box}",
